...
% differ from v1: use sliding window to calculate spike counts
...
fd_save = fullfile(fd_base, 'Figures', pairID, 'AcousticSpace', birdID, 'embed', [vae_run '_decodePopMatrix2'], 'intermediate');
...
cjoin = cjoin((cjoin.num_rend_c1>=min_rend) & (cjoin.num_rend_c2>=min_rend), :);
% compute a mean time

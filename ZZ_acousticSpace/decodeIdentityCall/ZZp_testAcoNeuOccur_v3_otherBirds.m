...
% Zhilei, 09/11/2025
% differ from v2: use the renaming where low-quality clusters were identified; convert decoding accuracy to similarity score
...
fd_data = fullfile(fd_base, 'Figures', pairID, 'AcousticSpace', birdID, 'embed', [vae_run '_decodePopMatrix5'], 'masked');
...
%     txaa = txa(ix); tyaa = tya(iy);
    ...
    imagesc(ax3, txnn, tynn, s, [0.3 0.95]);   
    ...
    imagesc(ax4, txnn, tynn, s, [0.3 0.95]);   

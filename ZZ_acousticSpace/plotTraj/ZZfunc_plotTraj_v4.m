function [img, ax] = ZZfunc_plotTraj_v4(ax, embed, info, num_plot, batches, r_seed, col_dict, marg, col_alpha, end_alpha, x_lim, y_lim, syl_type)
% given a embedding data table, plot trajectories of each syllable
% rasterized the scatter plot for easy edit in Illustrator
% differ from v3: add option to only plot certain syllable types

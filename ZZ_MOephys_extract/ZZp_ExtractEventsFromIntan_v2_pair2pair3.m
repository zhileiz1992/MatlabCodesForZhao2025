...
data_dates = {'2024-03-04', '2024-03-05', '2024-03-06', '2024-03-08', '2024-04-03', '2024-04-04'};

%% 1. Extract warble and standalone contact calls from Intan recordings
% di = 1;
for di=2:length(data_dates)
...
%         [dbase_subset, dbase_old] = ZZ_selectDbaseFocalWarbleFunc_v2(fn_dbase, fn_select);
        [dbase_subset, dbase_old] = ZZ_selectDbaseFocalWarbleFunc_v3(fn_dbase, fn_select);

...
% Dataset setting
meta.expID = 'ACU20BCU25';
% bird ID in the order of ephys channels in the intan file, if only one bird is recorded, use '' for the other bird
meta.birdID = {{'pair2RigACU20', 'pair2RigBCU25'}, {'', ''}}; 
meta.pairID = {'pair2CU20CU25', ''};
meta.cam = {'CamD', 'CamE'};  % what camera for each pair
meta.audio_ch_intan = [[2, 3]; []];  % what audio channels for each bird in intan file, 1st AI channel of Intan is speaker copy

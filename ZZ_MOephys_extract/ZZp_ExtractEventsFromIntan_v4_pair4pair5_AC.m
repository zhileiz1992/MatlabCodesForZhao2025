...
meta.audio_ch_intan = [[4, 5]; [6, 7]];  % for the new playback paradigm, ch1-3 are the playback
meta.playback_ch_intan = [1 2 3]; % what channel for all playback copies in intan
meta.playback_ch_box = [2 3];  % what channel for the box-specific playback
meta.trigger_ch_intan = 1;  % what channel for the trigger signal of pyVAQ
meta.ephys_ch_list = {{1:16, []}, {17:32, []}}; % what ephys channel for these two birds in intan, [] if only one bird is recorded 
meta.acc_ch_list = {{1:3, []}, {4:6, []}}; % what accelerometer channel for these two birds in intan
...
% data_dates = {'2025-01-19'};
data_dates = {'2024-12-25', '2024-12-26', '2024-12-27', '2024-12-28', '2024-12-29'};

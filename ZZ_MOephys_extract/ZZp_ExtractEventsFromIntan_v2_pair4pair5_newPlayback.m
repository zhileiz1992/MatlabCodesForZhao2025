...
meta.playback_ch_intan = [1 2 3]; % what channel for the contact call playback copy in intan
...
%% 4. Select warble episodes produced by the partner bird
di = 1;
data_date = data_dates{di};
for pi=1:length(meta.pairID)
  for bi=1:length(meta.birdID{pi})

...
fd_ckpt = '/mnt/z4/zz367/WarbleAnalysis/Results/WhisperSeg/20250509_JulieMirror20kCate5/final_checkpoint_ct2/';
...
for bi=1:size(birdIDs,2)
  ...
  dbase.Fs = 20000;
  % save dbase
  fn_save_this = fullfile(fd_wav_base, sprintf('%s.original.dbase.mat', bd));
  ...
  fn_seg = fullfile(fd_wav_base, sprintf('%s.applyJulie.dbase.mat', bd));
  save(fn_seg, 'dbase');
end
function [dbase, dbaseOld] = ZZ_flushDbaseSegmentationFunc_v2(dbase, onsets, offsets, labels)
% flush syllable segmentation into a dbase
% assume that each cell in onsets/offsets/labels correspond to one audio file in dbase
dbaseOld = dbase;

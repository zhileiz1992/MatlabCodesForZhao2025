...
data_dates = {'2023-09-11', '2023-09-12', '2023-09-13', '2023-09-14', '2023-09-15', ...
              ...
              '2023-10-26', '2023-11-04', '2023-11-05', '2023-11-08', '2023-11-12'};
cam = 'CamE';  % what camera for this pair of birds
audio_ch_pyvaq = [3, 4];  % what audio channels for this pair of birds in pyvaq
audio_ch_intan = [4, 5];  % what audio channels for this pair of birds in intan
bird_pos = 1;  % which bird, 1 means the 1st in the audio channel list
partner_pos = 2;

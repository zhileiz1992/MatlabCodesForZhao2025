...
ephys_ch_list = {1:16, 17:32}; % what ephys channel for these two birds in intan, [] if only one bird is recorded 
acc_ch_list = {1:3, 4:6}; % what accelerometer channel for these two birds in intan

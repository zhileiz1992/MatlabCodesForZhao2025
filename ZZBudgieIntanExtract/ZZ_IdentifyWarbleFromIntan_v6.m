function [warbleMetaAll, otherMetaAll] = ZZ_IdentifyWarbleFromIntan_v6(fd_base_intan, fd_base_save, data_date, meta)
    ...
    parfor jj=1:length(warbleStart)
      ...
      if ~isempty(saveWavPath)
        ...
        for ii=fileIdxStart:fileIdxEnd
          ...
          [signalThis, fs] = audioread(fullfile(fd_base_save, pairName, data_date, 'AllWav', fn_wav));
        ...
        audiowrite(fn_save, signalWarble, fs);
      end
    end
  end

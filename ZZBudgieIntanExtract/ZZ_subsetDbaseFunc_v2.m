function [dbase_subset, dbase_old] = ZZ_subsetDbaseFunc_v2(dbase, select_idx)
% subset a dbase
...
temp = dbase_old.AnalysisState.FileReadState;
dbase_subset.AnalysisState.FileReadState = temp(select_idx);

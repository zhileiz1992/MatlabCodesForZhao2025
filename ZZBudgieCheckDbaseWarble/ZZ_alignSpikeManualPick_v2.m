...
% what range of the sound files has been sorted
sorted_range = [1:36];
...
load(fn_dbase); 
% where to save
fd_save = fullfile(fd_save_base, 'auto_call_picked');
if ~exist(fd_save)
  mkdir(fd_save)
end
...
p1 = [1,2,4,12,20,26,27,31,34,54,56,57,58,59,64,70,73,77,80,81,82,83,84,91,94,95,113,118,122:127,129,130,133,134,136,139,140,164,165,173,180];
p = p1; 

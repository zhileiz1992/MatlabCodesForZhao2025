...
% differ from v1: remove the plots with the only 5 categories; 
% different background for different categories, highlight the category region with brown color

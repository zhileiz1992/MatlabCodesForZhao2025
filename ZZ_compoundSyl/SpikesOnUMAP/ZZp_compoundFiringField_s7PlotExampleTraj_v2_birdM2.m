...
% differ from v2: plot for bird M2
...
fn_sel_call = fullfile(fd_field, 'plot_comp', 'spike_spectrogram', neuronID, 'call1.txt');
idx_call = str2double(strsplit(readlines(fn_sel_call), ','));
fn_sel_comp = fullfile(fd_field, 'plot_comp', 'spike_spectrogram', neuronID, 'comp1.txt');

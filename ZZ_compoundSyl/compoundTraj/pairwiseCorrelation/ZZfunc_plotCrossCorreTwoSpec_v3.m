function [fig, axes_all, distm] = ZZfunc_plotCrossCorreTwoSpec_v3(d1, d2, spec1, sound2, clim2, cmap1, cmap2)
% differ from v2: used for call-compound syllable comparison
...
right_col_width = 0.15;   % Width of right column (for A and C; A and C will have same width)

...
% Zhilei, 09/28/2025
% differ from v3: loop over call subtypes and birds
...
syls_v = {{'v1', 'v2', 'v3', 'v4', 'v5', 'v6'}, {'v1', 'v2', 'v3', 'v4'}, {'v1', 'v2', 'v3'}, {'v1', 'v2', 'v3', 'v4'}};
...
% find peaks 
param.gapSize = 10;  
% param.thresholdFlatness = 0.03;  % first threshold to identify peak, 0.03 for v1
% param.extendThreshold = 0.015; % after thresholding extend to lower threshold to certain percentage of the peak height
param.thresholdFlatness = 0.015;  % first threshold to identify peak, 0.03 for v1
param.extendThreshold = 0.008;
...
for ii=1:(min([20 length(idx_plot)]))
  tar_i = idx_plot(ii);
  d2 = comp.dvae{tar_i};
  % grab sound
  [signal, fs] = audioread(comp.fn_wav{tar_i});

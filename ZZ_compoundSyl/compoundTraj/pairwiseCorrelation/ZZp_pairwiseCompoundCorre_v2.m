...
% differ from v1: instead of multiplying probability with amplitude, use AND operation
...
for ref_ii=1:length(ref_all)
  ref_i = ref_all(ref_ii);
...
prob_amp = smoothdata(prob_amp, 'gaussian', 11);
...
[onsets, offsets] = ZZfunc_GetProbOnsetOffset_v1(prob_amp, dt, param);

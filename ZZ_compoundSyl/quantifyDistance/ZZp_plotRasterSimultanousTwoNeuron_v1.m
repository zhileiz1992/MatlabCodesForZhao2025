% for for two simultenously recorded neurons, plot the raster aligned to syllable onset for calls and compound syllables
...
fd_raster= fullfile(fd_base, 'Figures', pairID, 'CompoundSyl', birdID, 'embed', [vae_run '_rasterSimul']);
if ~exist(fd_raster, 'dir'); mkdir(fd_raster); end



%% 2. Separate plots for calls and compound syllables

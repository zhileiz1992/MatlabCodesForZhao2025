function [ax, y_start] = ZZfunc_plotRasterNoWrap_v2(ax, d_plot, y_start, fs, marker, marker_size, marker_color, marker_alpha, x_lim, add_bar, bar_color, add_label, label_str, label_offset)
% plot the raster of spikes, no time-wrapping
% differ from v1: add bars to the left
hold(ax, 'on');
y_start_old = y_start; 
